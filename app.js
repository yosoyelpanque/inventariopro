    ...
    function loadState() {
        try {
            ...
            if (storedState) {
                ...
                // Si detecta una estructura de checkboxes antigua (o no existe), la actualiza a la nueva.
                if (!loaded.reportCheckboxes || typeof loaded.reportCheckboxes.labels === 'undefined') {
                    loaded.reportCheckboxes = {
                        labels: {},
                        notes: {},
                        mismatched: {}
                    };
...
async function startCamera() {
    ...
    function initialize() {
        ...
        elements.reports.tableBody.addEventListener('click', (e) => {
            ...
            if (saveBtn) {
                const itemId = Number(saveBtn.dataset.id);
